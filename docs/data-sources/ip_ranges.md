...
- `global_ipv4` (List of String) An Array of IPv4 addresses in CIDR format specifying the A records for the ??? endpoint.
- `global_ipv6` (List of String) An Array of IPv6 addresses in CIDR format specifying the A records for the ??? endpoint.
